...
MyExpRootDir = getwd()
APIKey = '1CS5B02G1G1OT2O6ZKQHD2ONS6ATUWUUB1C6PMNLEKHMLD83U2OROU88GI7PMIDT'
...
MyExp <- new("Graple", GWSURL=graplerURL, APIKey = APIKey, ExpRootDir=MyExpRootDir, ResultsDir=MyResultsDir,
